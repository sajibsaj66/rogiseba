...
class Operation2Body extends StatefulWidget {
  final String operationName;
  const Operation2Body({super.key, required this.operationName});

  @override
  State<Operation2Body> createState() => _Operation2BodyState();
}

class _Operation2BodyState extends State<Operation2Body> {
  @override
  void initState() {
    super.initState();
                                ...
                                children: [
                                  ...
                                  details(
                                    value.allHospital.data![index].hospitalName
                                        .toString(),
                                    "ক্যাটেগরি",
                                    "${value.allHospital.data![index].districtName.toString()}, ${value.allHospital.data![index].divisionName.toString()}",
                                  ),
                                ],
                              ),
                            ),
